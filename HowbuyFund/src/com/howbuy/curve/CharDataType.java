...
public class CharDataType {
	...
	public String toString(int dataType) {
		if (hasDataType()) {
			 ...
			 * mType.getName(), mData.toString(), "index=" + mIndex + ",what=" +
			 * mWhat+",obj="+mObj);
			 */
			return String.format("%1$s:%2$s", mType.getName(), mData.getValueStr(dataType));
		} else {
			return "--";
		}
	}
	...
	public String toString() {
		if (hasDataType()) {
			return String.format("type=%1$s,data=%2$s,extras{%3$s}", mType.getName(),
					mData.toString(), "index=" + mIndex + ",what=" + mWhat + ",obj=" + mObj);
		} else {
			return "--";
		}
	}
