...
public class DragSortListView extends ListView {
	...
	private class AdapterWrapper extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView != null) {
				...
				// }
				v.setBackgroundResource(R.drawable.theme_fund_item_background_holo_light);
	...
	private void updateFloatView() {
		...
		if (lastPos >= getCount() - numFooters - 1) {
			//add by yescpu check child view isNull 
			View view =getChildAt(getCount() - numFooters - 1 - firstPos); 
			if (view!=null) {
				bottomLimit = view.getBottom();
			}
		}
	...
	public void setListTouchListener(TouchListener l) {
		if (mFloatViewManager instanceof DragSortController) {
			((DragSortController) mFloatViewManager).setTouchListener(l);
		}
	}
