package howbuy.android.piggy.font;
...
public final class FontLoader {
	...
	public static class HoloFont implements FontSelector {
		...
		public static final HoloFont ROBOTO_THIN;

		static {
			ROBOTO = makeFont(ROBOTO_REGULAR = makeFont(R.raw.roboto_regular), ROBOTO_BOLD = makeFont(R.raw.roboto_bold), ROBOTO_ITALIC = makeFont(R.raw.roboto_italic),
					ROBOTO_BOLD_ITALIC = makeFont(R.raw.roboto_bolditalic), ROBOTO_THIN = makeFont(R.raw.roboto_thin));
		}

		public static HoloFont makeFont(HoloFont regular, HoloFont bold, HoloFont italic, HoloFont boldItalic, HoloFont thin) {
			return new HoloFontMerger(regular, bold, italic, boldItalic, thin);
		}
	...
	private static final class HoloFontMerger extends HoloFont {
		...
		private HoloFont mThin;

		public HoloFontMerger(HoloFont regular, HoloFont bold, HoloFont italic, HoloFont boldItalic, HoloFont thin) {
	...
	public static Typeface loadTypeface(Context context, int font) {
		...
		if (typeface == null) {
			try {
				...
				FontLoader.sFontCache.put(font, typeface = readTypeface(file, context.getResources(), font, true));
			} catch (Exception e) {
