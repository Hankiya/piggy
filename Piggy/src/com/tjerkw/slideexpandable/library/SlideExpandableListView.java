...
class SlideExpandableListView extends ListView {
	...
	private OnItemExpandCollapseListener mListener = null;
	...
	public void setOnItemExpandCollapseListener(OnItemExpandCollapseListener l) {
		mListener = l;
		if (adapter != null) {
			adapter.setItemExpandCollapseListener(mListener);
		}
	}
	...
	public void setAdapter(ListAdapter adapter) {
		...
		this.adapter.setItemExpandCollapseListener(mListener);
