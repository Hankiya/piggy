...
public class CurveSetting {
	protected float MIN_SPACE = 40;
	protected float MAX_SPACE = 120;
	protected String mMeasureTxt = "99.999";
	...
	public void setArrowSize(float dpVal) {
		this.mArrowSize = mDensity * dpVal;
	}
