...
/**
 * <p>
 * AsyPoolTask enables proper and easy use of the UI thread. This class allows
 * to perform background operations and publish results on the UI thread without
 * having to manipulate threads and/or handlers.
 * </p>
 * 
 * <p>
 * AsyPoolTask is designed to be a helper class around {@link Thread} and
 ...
 * <h2>Usage</h2>
 * <p>
 * AsyPoolTask must be subclassed to be used. The subclass will override at
 ...
 * private class DownloadFilesTask extends AsyPoolTask&lt;URL, Integer, Long&gt; {
 ...
 * </pre>
 * 
 * <h2>AsyPoolTask's generic types</h2>
 * <p>
 ...
 * 
 * <pre>
 * private class MyTask extends AsyPoolTask&lt;Void, Void, Void&gt; { ... }
 * </pre>
 * 
 * <h2>The 4 steps</h2>
 * <p>
 ...
 * </p>
 * <ul>
 * <li>The AsyPoolTask class must be loaded on the UI thread. This is done
 ...
 * <p>
 * AsyPoolTask guarantees that all callback calls are synchronized in such a way
 ...
 * </p>
 */
public abstract class AsyPoolTask<Params, Progress, Result> {
	private static final String LOG_TAG = "AsyPoolTask";
	private static final int CPU_COUNT = Runtime.getRuntime().availableProcessors();
	private static final int CORE_POOL_SIZE = CPU_COUNT * 2 + 1;
	private static final int MAXIMUM_POOL_SIZE = Math.min(CPU_COUNT * 25 + 1, 128);
	...
	private static final ThreadFactory sThreadFactory = new ThreadFactory() {
		...
		public Thread newThread(Runnable r) {
			return new Thread(r, "AsyPoolTask #" + mCount.getAndIncrement());
		}
	};
	...
	private static final BlockingQueue<Runnable> mPoolSingleQueue = new LinkedBlockingQueue<Runnable>(
			64);
	public static final Executor THREAD_SINGLE_EXECUTOR = new ThreadPoolExecutor(1, CPU_COUNT, 1,
			TimeUnit.SECONDS, mPoolSingleQueue, sThreadFactory);
	...
	private static class SerialExecutor implements Executor {
		...
		protected synchronized void scheduleNext() {
			if ((mActive = mTasks.poll()) != null) {
				THREAD_SINGLE_EXECUTOR.execute(mActive);
			}
		}
	}
	...
	public enum Status {
		...
		RUNNING,
		/**
		 * Indicates that {@link AsyPoolTask#onPostExecute} has finished.
		 */
		FINISHED,
	}
	 ...
	 *            The parameters of the task.
	 * 
	 * @return This instance of AsyPoolTask.
	 * 
	 * @throws IllegalStateException
	 *             If {@link #getStatus()} returns either
	 *             {@link AsyPoolTask.Status#RUNNING} or
	 *             {@link AsyPoolTask.Status#FINISHED}.
	 * 
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 * @see #execute(Runnable)
	 */
	public final AsyPoolTask<Params, Progress, Result> execute(boolean parallel, Params... params) {
		if (parallel) {
	 ...
	 * AsyPoolTask, however you can also use your own {@link Executor} for
	 * custom behavior.
	 * 
	 * <p>
	 ...
	 * @see #execute(Object[])
	 */
	public final AsyPoolTask<Params, Progress, Result> executeOnExecutor(Executor exec,
			Params... params) {
	 ...
	 * @see #executeOnExecutor(java.util.concurrent.Executor, Object[])
	 */
	public static void execute(boolean parallel, Runnable runnable) {
		if (parallel) {
	...
	public static boolean isTaskStopped(AsyPoolTask task) {
		return task == null || task.getStatus() == AsyPoolTask.Status.FINISHED;
	}
	...
	private static class AsyncTaskResult<Data> {
		final AsyPoolTask mTask;
		final Data[] mData;

		AsyncTaskResult(AsyPoolTask task, Data... data) {
			mTask = task;
			mData = data;
		}
	}
