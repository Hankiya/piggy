 ...
 */
public class ParFtenYearReportList extends AbsParam{
	public static final String URL="ften/ndbg/XXXX.protobuf";
	//参数	值	能否为空	描述
	private String code=null;//	000001	N	公告主键
	private int pageCount=1;	//		每页数量
	private int currentPage	=1;	//	当前页
	public ParFtenYearReportList setParams(String code,int currentPage,int pageCount){
		this.pageCount=pageCount;
		this.currentPage=currentPage;
		this.code=code;
		return this;
	} 
	public ParFtenYearReportList(long cacheTime) {
		super(cacheTime);
	}
	public ParFtenYearReportList(int handType, Handler uiHand, long cacheTime) {
		super(handType, uiHand, cacheTime);
	}

	public ParFtenYearReportList(int handType, IReqNetFinished calbk, long cacheTime) {
		super(handType, calbk, cacheTime);
	}

	public ParFtenYearReportList(String key, int handType, IReqNetFinished calbk,
			Handler uiHand, long cacheTime) {
		super(key, handType, calbk, uiHand, cacheTime);
	}

	public ParFtenYearReportList(String key, IReqNetFinished calbk, long cacheTime) {
